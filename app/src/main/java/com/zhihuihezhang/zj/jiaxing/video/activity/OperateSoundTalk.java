...
public class OperateSoundTalk extends Activity {
    ...
    private void closeTalk() {
        ...
        // 根据通道号关闭对讲
        if ( rvi != null ) {
              ret = IDpsdkCore.DPSDK_CloseTalkStreamBySeq(m_pDLLHandle, rvi.nReturnValue, DPSDK_CORE_DEFAULT_TIMEOUT);
        }
    ...
    private void startTalk() {
        ...
        int ret = IDpsdkCore.DPSDK_GetTalkStream(m_pDLLHandle, rvi, gti, fmdCallback, DPSDK_CORE_DEFAULT_TIMEOUT);
        ...
        IDpsdkCore.DPSDK_GetSdkAudioCallbackInfo(m_pDLLHandle, afInfo);
   
        // 打开音频采集功能
        IPlaySDK.PLAYOpenAudioRecord(fun, dpsdk_talk_bits_e.Talk_Audio_Bits_16, Talk_Sample_Rate_e.Talk_Audio_Sam_8K, 1024, 0);
    }
