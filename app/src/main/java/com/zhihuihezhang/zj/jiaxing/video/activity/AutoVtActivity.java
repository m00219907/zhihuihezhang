...
import com.zhihuihezhang.zj.jiaxing.video.entity.NotifyEntity;
import com.zhihuihezhang.zj.jiaxing.video.groupTree.GroupListActivity;
import com.zhihuihezhang.zj.jiaxing.video.util.MusicTool;
...
//                    mPlayWindow.setVisibility(View.GONE);
                ...
                case PLAYVIEW:   //开始可视对讲
                    ...
                    final Return_Value_Info_t retVal1 = new Return_Value_Info_t();
                    IDpsdkCore.DPSDK_InviteVtCall(mPDLLHandle, retVal0, retVal1, mInviteVtCallParam, mInviteVtCallParam.nCallType, new fMediaDataCallback() {
                        @Override
    ...
    private void setListeners() {
        ...
        offlineImg.setOnClickListener(new OnClickListener() {  
            ...
            public void onClick(View v) {
                ...
                stopPlay();  //stop video
                stopTalk();  //stop audio
                IDpsdkCore.DPSDK_StopVtCall(mPDLLHandle, mInviteVtCallParam.szUserId, mAudioSessionId, mVideoSessionId, mInviteVtCallParam.callId,mInviteVtCallParam.dlgId, mTimeOut);
                Message msg = mHandler.obtainMessage();
        ...
        //设备主动挂断回调
        IDpsdkCore.DPSDK_SetGeneralJsonTransportCallback(mPDLLHandle,new fDPSDKGeneralJsonTransportCallback() {
    ...
    private void setDPSDKCallback() {
        ...
        mfDPSDKPecDoorStarusCallBack = new fDPSDKPecDoorStarusCallBack() {
            ...
            public void invoke(int nPDLLHandle, byte[] szCameraId, int nStatus,
                ...
                Toast.makeText(AutoVtActivity.this , new String(szCameraId)+" status :"+nStatus, Toast.LENGTH_SHORT).show();
            }
        };
    }
    ...
    private int startTalk(){
        ...
        audioFunInfo = new Audio_Fun_Info_t();
            IDpsdkCore.DPSDK_GetAudioSendFunCallBack(mPDLLHandle, audioFunInfo);
